...
*/
public abstract class DetonatorComponent : MonoBehaviour//Clase base dels detonator
{
	public bool on = true;
	...
	*/
	...
	public Detonator MyDetonator()//Metode per a conseguir els materials del detonador en cas de ser necessari
	{
